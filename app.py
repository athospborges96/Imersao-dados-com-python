...
col_graf3, col_graf4_a, col_graf4_b = st.columns(3)
with col_graf3:
    if not df_filtrado.empty:
        ...
        st.plotly_chart(grafico_remoto)
    else:
...
with col_graf4_a:
    if not df_filtrado.empty:
        ...
        st.plotly_chart(grafico_paises)
    else:
...
with col_graf4_b:
    if not df_filtrado.empty:
        df_ds = df_filtrado[df_filtrado['cargo'] == 'Data Scientist']
        media_ds_pais = df_ds.groupby('residencia_iso3')['usd'].mean(
        ...
        st.plotly_chart(grafico_paises_barras)
